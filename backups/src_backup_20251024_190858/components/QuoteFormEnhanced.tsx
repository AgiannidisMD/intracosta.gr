                          ...
                          <div className="space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div className="mb-4">
                              <label className="block text-sm font-semibold text-gray-700 mb-3">
                                Τύπος Μέτρησης <span className="text-red-500">*</span>
                              </label>
                              <div className="grid grid-cols-2 gap-3">
                                <button
                                  type="button"
                                  onClick={() => setDimensionType('ldm')}
                                  className={`flex items-center justify-center px-4 py-3 rounded-lg border-2 transition-all font-medium ${
                                    dimensionType === 'ldm'
